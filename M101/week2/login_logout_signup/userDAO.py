...
class UserDAO:
    ...
    def make_pw_hash(self, pw,salt=None):
        if salt == None:
            ...
            pw = pw.encode('utf-8')
        return str(hashlib.sha256(pw + salt).hexdigest())+","+ str(salt)
    ...
    def validate_login(self, username, password):
        ...
        if user['password'] != str(self.make_pw_hash(password, salt)):
    ...
    def add_user(self, username, password, email):
        password_hash = str(self.make_pw_hash(password))
